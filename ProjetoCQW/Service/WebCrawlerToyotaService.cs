...
namespace ProjetoCQW.Service
{
    public class WebCrawlerToyotaService : IWebCrawlerToyotaService
    {
        ...
        public async Task<ModeloCarro> UpdateXS(int modeloCarroID, int modeloSiteID)
        {
            if (modeloCarroID == 0)
            {
                throw new IdNotFoundException("modeloCarroID inválido");
            ...
            using (IWebDriver driver = new ChromeDriver(options))
            {
                ...
                var botao = driver.FindElement(By.XPath("//*[@id=\"dynamic-component-0\"]/div[2]/section/div/section[1]/div[2]/div/div/div/div/div[2]/div/div/button"));
                botao.Click();
